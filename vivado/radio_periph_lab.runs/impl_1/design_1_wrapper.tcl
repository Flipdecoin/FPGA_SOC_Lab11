namespace eval ::optrace {
  variable script "Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.cache/wt [current_project]
  set_property parent.project_path Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.xpr [current_project]
  set_property ip_repo_paths Z:/FPGA_SOC/Lab11/ip_repo [current_project]
  update_ip_catalog
  set_property ip_output_repo Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files Z:/FPGA_SOC/Lab11/vivado/radio_periph_lab.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc Z:/FPGA_SOC/Lab11/src/toplevel.xdc
